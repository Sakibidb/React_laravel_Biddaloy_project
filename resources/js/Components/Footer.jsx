...
const Footer = () => {
  return (
    ...
    <div className="footer_background" style={{backgroundImage: 'url(images/footer_background.png)'}} />
      ...
      <div className="row copyright_row">
        <div className="col">
          <div className="copyright d-flex flex-lg-row flex-column align-items-center justify-content-start">
            <div className="cr_text">{/* Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. */}
